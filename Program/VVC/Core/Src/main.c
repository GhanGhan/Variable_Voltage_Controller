...
/* USER CODE BEGIN PV */
const float sys_voltage = 3.3;//ADC reference voltage
const uint16_t adc_res = 4095;
const uint8_t vi_scale = 17; //largest allowable input voltage
